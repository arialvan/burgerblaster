                                                ...
                                                ?>
                                                    <tr class="showmove">
                                                        ...
                                                        <?php if($admin==1){?>
                                                                ...
                                                                <a href="bill_done.php?id=<?php echo $key2['id_pes']; ?>&id_meja=<?php echo $key2['id_meja']; ?>&tgl=<?php echo $key2['date']; ?>&id_ot=<?php echo $idot; ?>" class="btn btn-primary btn-xs text-right" title="Save as Payment" onclick="return confirm('Save sebagai pembelian ?')"><span class="glyphicon glyphicon-save"></span></a>&nbsp;&nbsp;
