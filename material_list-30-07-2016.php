        ...
        <div id="page-wrapper" >
			...
			$table = "material JOIN material_stock ON material.id_material=material_stock.id_material";
						...
						<td><?php echo $key['unit']?></td>
                                                ...
                                                <td><a href="#" class="myeditable" data-type="text" data-pk="<?php echo $key['id_material']; ?>" data-name="stock" data-url="materialstocksave.php" data-original-title="Enter Stock"><?php echo $key['qty_material']?></a></td>
                                               <td>
