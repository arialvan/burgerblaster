        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
					...
					?>
                                        <tr>
                                            <td><?php echo $key['nama_cs'];?></td>
                                            <td><?php echo $key['hp_cs'];?></td>
                                            <td><?php echo $key['email_cs'];?></td>
                                            <td><?php echo $key['alamat_cs'];?></td>
                                            <td>
                                                <a href='csedit.php?id_cs=<?php echo $key['id_cs'] ?>' title="Edit"><span class="glyphicon glyphicon-pencil Edit"></span></a>&nbsp;&nbsp;
					...
					<?php } ?>
                            ...
                            <br />
                            <input type="button" class="btn btn-primary btn-lg" value="Add Customer" onclick="window.location='csadd.php'"/>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
