        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    <?php
                        //Omset harian
                        $stmt12=$con->prepare("SELECT SUM(total) AS Masuk FROM order_done where MONTH(date_done)='$bulan' AND YEAR(date_done)='$tahun' AND id_outlet='$outlet'");
                        $stmt12->execute();
                        ...
                        //Bahan Baku
                        $stmt3=$con->prepare("SELECT SUM(total_mp) AS ttmp FROM material_purchase where MONTH(tgl_mp)='$bulan' AND YEAR(tgl_mp)='$tahun' ");
			$stmt3->execute();
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3 class="text-center">BULAN <?php echo $bulan; ?> TAHUN <?php echo $tahun; ?></h3><hr />
                        <p>&nbsp;</p><p>&nbsp;</p>
