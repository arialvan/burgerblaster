            ...
            <div id="page-inner">
                <div class="row">
                   <div class="text-primary col-sm-10">
                        <h3>Laporan Bulan <?php echo $bulan; ?></h3>
                   </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    $table = "product JOIN order_done ON product.id_product=order_done.id_product";
                                     ...
                                     $stmt=$con->prepare("SELECT SUM(total_mp) AS D FROM material_purchase WHERE id_outlet=:id_outlet AND MONTH(tgl_mp)=:tanggal AND YEAR(tgl_mp)=:tahun AND LEFT(id_material,1)='D'" );
                                        $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                        $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                    ...
                                    // Pengeluaran Bahan Baku Burger
                                     $stmt=$con->prepare("SELECT SUM(total_mp) AS B FROM material_purchase WHERE id_outlet=:id_outlet AND MONTH(tgl_mp)=:tanggal AND YEAR(tgl_mp)=:tahun AND LEFT(id_material,1)='B'" );
                                        $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                        $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                        $stmt->bindValue(':tahun', $tahun, PDO::PARAM_STR);
                                        $stmt->execute();	
                                    ...
                                    // Pengeluaran harian Query
                                     $stmt=$con->prepare("SELECT *,SUM(purchase_detail.total_prc) AS spending FROM purchase JOIN purchase_detail ON purchase.id_purchase=purchase_detail.id_purchase
                                                          WHERE purchase.id_outlet=:id_outlet AND MONTH(purchase.purchase_date)=:tanggal AND YEAR(purchase.purchase_date)=:tahun");
                                        $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                        $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                        $stmt->bindValue(':tahun', $tahun, PDO::PARAM_STR);
                                        $stmt->execute();	
                                            ...
                                            <td colspan="6" class="hiddenRow">
                                                <div id="demo21" class="accordian-body collapse">
                                                    ...
                                                    $stmt=$con->prepare("SELECT * FROM material JOIN material_purchase ON material.id_material=material_purchase.id_material
                                                                         WHERE material_purchase.id_outlet=:id_outlet AND MONTH(material_purchase.tgl_mp)=:tanggal AND YEAR(material_purchase.tgl_mp)=:tahun AND LEFT(material_purchase.id_material,1)='D' ");
                                                            $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tahun', $tahun, PDO::PARAM_STR);
                                                            $stmt->execute();	
                                        ...
                                        <tr>
                                            <td colspan="6" class="hiddenRow">
                                                <div id="demo22" class="accordian-body collapse">
                                                    ...
                                                    <?php
                                                    $stmt=$con->prepare("SELECT * FROM material JOIN material_purchase ON material.id_material=material_purchase.id_material
                                                                         WHERE material_purchase.id_outlet=:id_outlet AND MONTH(material_purchase.tgl_mp)=:tanggal AND YEAR(material_purchase.tgl_mp)=:tahun AND LEFT(material_purchase.id_material,1)='B' ");
                                                            $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tahun', $tahun, PDO::PARAM_STR);
                                                            $stmt->execute();	
                                        ...
                                        <tr>
                                            <td colspan="6" class="hiddenRow">
                                                <div id="demo2" class="accordian-body collapse">
                                                    <span class="text-danger">
                                                    <?php
                                                    $stmt=$con->prepare("SELECT * FROM purchase JOIN purchase_detail ON purchase.id_purchase=purchase_detail.id_purchase WHERE purchase.id_outlet=:id_outlet AND MONTH(purchase.purchase_date)=:tanggal AND YEAR(purchase.purchase_date)=:tahun");
                                                            $stmt->bindValue(':id_outlet', $idot, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tanggal', $bulan, PDO::PARAM_STR);
                                                            $stmt->bindValue(':tahun', $tahun, PDO::PARAM_STR);
                                                            $stmt->execute();	
                            ...
                            <br />
                                <input type="button" class="btn btn-primary btn-lg" value="Cetak Laporan" onclick="window.location='cash_monthly.php?bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>&outlet=<?php echo $idot; ?>'" />
                        </div>
                    </div>
                    <!--End Advanced Tables -->
                </div>
