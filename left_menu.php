...
<!-- REPORT ============================-->                
                ...
                <li><a href="#"><i class="fa fa-bar-chart-o fa-2x"></i>Report <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="">Cash Book<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="cash_list.php">Daily</a></li>
                                    <li><a href="cash_list_month.php">Monthly</a></li>
                                </ul>
                        </li>
...
<!-- DATA VIEW ============================-->                 
                ...
                <li><a href="dataview.php"><i class="fa fa-database fa-2x"></i>Data View<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#"><i class="fa fa-user fa-2x"></i>User<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="userlist.php"><i class="fa fa-list fa-2x"></i>User List</a></li>
                                    <li><a href='useredit.php?id_user=<?php echo $_SESSION['ID'] ?>' class='fa fa-edit'><i class="fa fa-user-md fa-2x"></i>My Account</a></li>
                                </ul>
                        </li>
                        <li><a href="cslist.php"><i class="fa fa-users fa-2x"></i>Customer</a></li>
                        <li><a href="dataview.php"><i class="fa fa-database fa-2x"></i>Data View</a></li>
                    </ul>
                </li>
                 <?php } ?>
                    ...
                    <li><a href="#"><i class="fa fa-gears fa-2x"></i>Setting<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="#">Customer<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="csadd.php">Add Customer</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="meja_list.php">Tables</a></li>
                        </ul>
                    </li>
                    
                    <li><a href="datainput.php"><i class="fa fa-save fa-2x"></i>Input Data<span class="fa arrow"></span></a></li>
                    <?php } ?>   
