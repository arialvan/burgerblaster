                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                    	<?php
                                            //$table = "purchase JOIN purchase_detail ON purchase.id_purchase=purchase_detail.id_purchase JOIN material ON purchase_detail.id_material=material.id_material";
						...
						<td><?php echo $key2['qty_prc']."-".$key2['unit_prc']; ?></td>
                                                ...
                                                <td><a href='purchase_edit.php?id_purchase=<?php echo $key2['id_purchase'] ?>&id_material=<?php echo $key2['id_material'] ?> ' title="Edit"><span class="glyphicon glyphicon-pencil Edit"></span></a>&nbsp;&nbsp;</td>
                                            </tr>
